    ...
    <>
      ...
      <section style={{ background: "#faf9f7", padding: isMobile ? "52px 20px" : "80px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: "center", gap: isMobile ? 40 : 80 }}>
          ...
          {!isMobile && (
            <div style={{ flex: 1 }}>
              <div style={{ width: "100%", aspectRatio: "4/3", background: `linear-gradient(135deg, ${BRAND.colorLight}, ${BRAND.colorMid})`, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <div style={{ textAlign: "center", padding: 40 }}>
                  <div style={{ fontSize: "3.5rem", marginBottom: 14 }}>🏡</div>
                  <div style={{ fontFamily: "'Helvetica Neue', sans-serif", color: BRAND.color, fontSize: "0.9rem", fontWeight: 600 }}>Award winning results</div>
                  <div style={{ fontFamily: "'Helvetica Neue', sans-serif", color: "#666", fontSize: "0.8rem", marginTop: 6 }}>because your property deserves nothing less</div>
                </div>
              </div>
            </div>
          )}
      ...
      <section style={{ background: "#1a1a1a", padding: "24px 20px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
          <p style={{ fontFamily: "'Helvetica Neue', sans-serif", color: "#999", fontSize: "0.72rem", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 14 }}>Australia's Most Awarded Real Estate Agency</p>
        ...
        <div className="section">
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 36 }}>
            {[
              ...
              { icon: "⭐", title: "Thousands of happy clients.", desc: "With over 10,000 successful transactions and a 4.9-star average rating, Bettersale is one of Australia's most trusted agencies." },
            ].map((t) => (
              <div key={t.title}>
        ...
        <div className="section">
          <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", justifyContent: "space-between", alignItems: isMobile ? "flex-start" : "center", marginBottom: 28, gap: 16 }}>
            <div>
              ...
              <p style={{ fontFamily: "'Helvetica Neue', sans-serif", color: "#888", fontSize: "0.83rem" }}>{filtered.length} {filtered.length === 1 ? "property" : "properties"} {search ? `matching "${search}"` : "across Australia"}</p>
            </div>
